...
public class TodoService {
	...
	static {
		todos.add(new Todo(1, "Aman", "Learn Spring MVC", new Date(), false));
		todos.add(new Todo(2, "Aman", "Learn Struts", new Date(), false));
		todos.add(new Todo(3, "Aman", "Learn Hibernate", new Date(), false));
	}
